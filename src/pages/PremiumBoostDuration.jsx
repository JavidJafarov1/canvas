...
const PremiumBoostDuration = () => {
  ...
  const handleContinue = () => {
    navigate('/premium-boost/audience', {
      state: {
        ...incomingState,
        duration,
      }
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              <img src='/assets/images/vector39.png' alt='vector39' className='w-11' />
              <div>
          ...
          >
            <div className="flex items-center gap-3">
              <img src='/assets/images/vector40.png' alt='vector40' className='w-11' />
              <div>
...
export default PremiumBoostDuration;
