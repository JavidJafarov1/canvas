...
const BotTaskSuccess = () => {
  const navigate = useNavigate();
  const location = useLocation();

  const state = location.state || {};
  const channelLabel = state.channel || '@my_earn_bot';
  ...
  const details = [
    { label: 'Тип:', value: 'Перейти в бота', isLink: false },
    { label: 'Бот:', value: channelLabel, isLink: true },
