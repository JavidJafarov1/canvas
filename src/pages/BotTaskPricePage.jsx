      ...
      <div className="flex flex-col font-sans text-white relative min-h-screen">
        <div className='p-[10px_15px_22px_15px] border-b border-b-white/10'>
          ...
          <div className='flex items-center justify-center mb-4 relative h-[50px]'>
            ...
            {/* Bot Icon Container */}
            <img src={BOT_ICON} alt="bot-icon" className="w-[50px] h-[50px]" />
          </div>
        ...
        <div className="flex flex-col gap-3 p-4 pb-0">
          ...
          >
            ...
            {isPriceError && (
              ...
              >
                ...
                <p className="text-xs font-medium text-[#FFB7C8]">Мінімум {MIN_PRICE} ¢</p>
              </div>
            )}
          ...
          <div className="flex flex-col gap-2 mt-1">
            <button
              onClick={() => navigate('/bot-task-success', { state: { ...location.state, price: priceNum, executions: execNum, total } })}
            ...
            <button
              onClick={() => navigate('/bot-task-success', { state: { ...location.state, price: priceNum, executions: execNum, total, payWithStars: true } })}
...
export default BotTaskPricePage;
