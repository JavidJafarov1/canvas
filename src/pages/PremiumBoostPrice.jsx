      ...
      <div className="flex flex-col font-sans text-white relative min-h-screen">
        ...
        <div className="flex flex-col gap-3 p-4 pb-0">
          ...
          <div className="flex flex-col gap-2 mt-1">
            <button
              onClick={() => navigate('/premium-boost/success', { state: { ...location.state, price: priceNum, executions: execNum, total } })}
            ...
            <button
              onClick={() => navigate('/premium-boost/success', { state: { ...location.state, price: priceNum, executions: execNum, total, payWithStars: true } })}
...
export default PremiumBoostPrice;
