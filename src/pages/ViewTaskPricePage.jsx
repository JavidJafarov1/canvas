...
import { ChevronLeft, ChevronUp, ChevronDown, Eye } from 'lucide-react';
    ...
    <Layout showNavbar={false}>
      <div className="flex flex-col font-sans text-white relative min-h-screen">
        <div className='p-[10px_15px_22px_15px] border-b border-b-white/10'>
          ...
          {/* Step Progress - 3 steps total: step 3 active */}
        ...
        <div className="flex flex-col gap-3 p-4 pb-0">
          ...
          >
            ...
            {isPriceError && (
              <div
                className="flex items-center gap-2 rounded-full px-4 py-2.5 bg-[#FF4973]/10 border border-[#FF4973]/5"
              >
                <img src='/assets/images/svg/xmark-octagon.svg' alt='xmark-octagon' />
                <p className="text-xs font-medium text-[#FFB7C8]">Мінімум 750 ¢</p>
              </div>
            )}
          ...
          <div className="flex flex-col gap-2 mt-1">
            <button
              onClick={() => navigate('/view-task-success', { state: { ...location.state, price: priceNum, executions: execNum, total } })}
            ...
            <button
              onClick={() => navigate('/view-task-success', { state: { ...location.state, price: priceNum, executions: execNum, total, payWithStars: true } })}
...
export default ViewTaskPricePage;
