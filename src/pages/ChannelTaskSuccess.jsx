...
const ChannelTaskSuccess = () => {
  const navigate = useNavigate();
  const location = useLocation();

  const state = location.state || {};
  const channelLabel = state.channel || '@trading_hub_pro';
  ...
  const details = [
    { label: 'Тип:', value: 'Підписка на канал', isLink: false },
...
export default ChannelTaskSuccess;
