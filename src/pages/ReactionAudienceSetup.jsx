    ...
    <Layout showNavbar={false}>
      <div className="flex flex-col font-sans text-white relative min-h-screen">
        ...
        <div className="mt-auto pt-4 px-[18px]">
          <button
            onClick={() => navigate('/reaction-task-price', { state: { ...location.state, accountType, audienceType, selectedLangs } })}
...
export default ReactionAudienceSetup;
