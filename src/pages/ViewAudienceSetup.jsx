    ...
    <Layout showNavbar={false}>
      <div className="flex flex-col font-sans text-white relative min-h-screen">
        <div className='p-[10px_15px_22px_15px] border-b border-b-white/10'>
          ...
          {/* Step Progress - 3 steps total, step 2 active */}
        ...
        <div className="mt-auto pt-4 px-[18px]">
          <button
            onClick={() => navigate('/view-task-price', { state: { ...location.state, accountType, audienceType, selectedLangs } })}
...
export default ViewAudienceSetup;
