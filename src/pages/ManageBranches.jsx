      ...
      <div>
        ...
        <div className='relative w-full flex items-center justify-center mt-6 mb-3 px-4'>
          ...
          >
            ...
            <div className='w-[60px] h-[60px] rounded-full flex items-center justify-center z-10'>
              <img src="assets/images/groupLine.png" alt="group" />
            </div>
        </div>
        ...
        <div className='px-4'>
          <div className='gradient-border-card rounded-[20px] flex flex-col divide-y divide-white/[0.06] overflow-hidden' 
            ...
            {/* Row 1: General */}
            <div className='p-[12px_10px] flex items-center justify-between transition-colors'>
              <div className='flex items-center gap-3.5'>
                {/* Icon Container */}
                <div className='w-[44px] h-[44px] rounded-full flex items-center justify-center shrink-0'>
                  <img src="assets/images/global.png" alt="planet" />
                </div>
                <div className='flex flex-col'>
                  <span className='text-sm font-medium text-white'>General</span>
                  <span className='text-[#ffffff]/40 text-[12px] mt-1'>Основні новини та оновлення</span>
                </div>
              </div>
            ...
            <div className='p-[12px_10px] flex items-center justify-between transition-colors'>
              <div className='flex items-center gap-3.5'>
                <img src="assets/images/red-arrow.png" alt="cursor" className='w-11 h-11' />
                <div className='flex flex-col'>
                  <span className='text-sm font-medium text-white'>TEST 1</span>
                  <span className='text-[#ffffff]/40 text-[12px] mt-1'>Тестовий топік 1</span>
                </div>
              </div>
            ...
            <div className='p-[12px_10px] flex items-center justify-between transition-colors'>
              <div className='flex items-center gap-3.5'>
                <img src="assets/images/red-arrow.png" alt="cursor" className='w-11 h-11' />
                <div className='flex flex-col'>
                  <span className='text-sm font-medium text-white'>TEST 2</span>
                  <span className='text-[#ffffff]/40 text-[12px] mt-1'>Тестовий топік 2</span>
                </div>
              </div>
            ...
            <div className='p-[12px_10px] flex items-center justify-between transition-colors'>
              <div className='flex items-center gap-3.5'>
                <img src="assets/images/red-arrow.png" alt="cursor" className='w-11 h-11' />
                <div className='flex flex-col'>
                  <span className='text-sm font-medium text-white'>TEST 3</span>
                  <span className='text-[#ffffff]/40 text-[12px] mt-1'>Тестовий топік 3</span>
                </div>
              </div>
