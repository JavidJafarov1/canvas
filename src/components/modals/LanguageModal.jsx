...
const LanguageModal = ({ isOpen, onClose, selectedLanguage, onSelectLanguage }) => {
  ...
  return (
    <div className='fixed inset-y-0 left-1/2 -translate-x-1/2 max-w-[375px] w-full bg-[#0B0E21]/80 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-fadeIn'>
      ...
      >
        {/* Globe Icon Circle */}
        <img src='/assets/images/vector16.png' alt='vector16' className='w-[58px] mb-4' />

        {/* Title & Subtitle */}
        <h2 className='text-lg font-medium text-white text-center tracking-wide mb-1'>Interface language</h2>
        <p className='text-xs text-white/40 text-center mb-4'>Select interface display language</p>
